...
export default function CourseCard({course}) {
    ...
    const {title , description , category , numbersOfLectures , thumbnail , _id } = course
  ...
  return (
    <div className="card card-compact bg-base-100 w-96 shadow-xl cursor-pointer ">
      ...
      <div className="card-body">
        ...
        <p>{description}</p>
        <p  > <span className="text-yellow-500 font-semibold" >Lectures:</span> {numbersOfLectures}</p>
        <div>
